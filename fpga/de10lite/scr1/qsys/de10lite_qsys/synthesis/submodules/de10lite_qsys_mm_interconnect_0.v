...
module de10lite_qsys_mm_interconnect_0 (
	...
	wire  [118:0] sdram_s1_agent_rf_source_data;                                  // sdram_s1_agent:rf_source_data -> sdram_s1_agent_rsp_fifo:in_data
	...
	wire  [118:0] sdram_s1_agent_rsp_fifo_out_data;                               // sdram_s1_agent_rsp_fifo:out_data -> sdram_s1_agent:rf_sink_data
	...
	wire  [117:0] cmd_mux_003_src_data;                                           // cmd_mux_003:src_data -> sdram_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                          // sdram_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [10:0] cmd_mux_003_src_channel;                                        // cmd_mux_003:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [117:0] sdram_s1_agent_rp_data;                                         // sdram_s1_agent:rp_data -> router_005:sink_data
	...
	de10lite_qsys_mm_interconnect_0_router_002 router_005 (
